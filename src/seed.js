  ...
  if (!executed) {
    const products = [
      ...
      },
      {
        ...
        type: "album",
        amount: 9.99,
        image: "https://universalmusic.vteximg.com.br/arquivos/ids/159803-1000-1000/cd-freddie-mercury-mr-bad-guy-cd-freddie-mercury-mr-bad-guy-00602577810374-26060257781037.jpg?v=637060789367800000",
        size: [],
      },
      {
